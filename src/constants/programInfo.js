import logo from "../images/logo_adapt.png" // add school logo to images folder and import here
...
export const schoolInfo = { // term details section
    ...
    immediateRepayment: [
        { // for multiple examples of immmediate repayment, add items to immediateRepayment array
            programName: '',
            APR36: '11.69%',
            financeCharge36: '$599.78',
            FullMonthlyPayment36: '$104.16',
            APR60: 'XX.XX%',
            financeCharge60: '$X,XXX.XX',
            FullMonthlyPayment60: '$XXX.XX',
            LoanExampleAmt: '$3,150',
            LoanExampleOFeeAmt: '$126',
            LoanExampleAmtPlusOFee: '$3,276'
        }
    ]
}
...
export const faq = { // faq section
    ...
    loanRange: [
        {
            programName: "Mastering The Basics",
            maxAmount: "$3,150",
            col: false,
            colAmount: "$6,000"
        }
...
export const schoolName = "ADAPT"

export const schoolURL = 'https://www.adaptdental.com/' // update with url of school's website

export const skfURL = 'https://adapt.skills.fund' // update with Skills Fund url

export const headline = "Become a Dental Assistant with ADAPT" // update headline as appropriate

export const leadContent = {
    header: "Your last step on the path toward changing your career",
    paragraph: `${schoolName} designs its Mastering The Basics program to help students prepare for a career in Dental Assistance. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "ADAPT offers funding for its Mastering The Basics program."
    },
    step3: `You'll be on your way to an exciting career as a Dental Assistant.`
}

export const netlifyFormName = 'ADAPT_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "5106a9d2-650f-4197-9b17-e1b9f6686bd1" // create Hubspot form, get form id after publishing
...
export const defaultLoanAmount = 3150
export const placeholder = '$3,150'
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKAD18",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $3,150 for ADAPT's Mastering The Basics tuition."
