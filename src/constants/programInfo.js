...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its Mastering The Basics program to help students prepare for a career in Dental Assistance. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const programLoanInfo = [
	// update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
	{
		...
		url: 'https://my.skills.fund/application?lenderCode=SKAD18',
		loanInfo: {
...
export const programMaxText =
	"Choose the loan amount that works best for you. Borrow up to $3,150 for ADAPT's Mastering The Basics tuition.";
